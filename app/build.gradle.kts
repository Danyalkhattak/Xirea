...
android {
    ...
    fun signingProp(key: String): String? {
        return signingProps.getProperty(key) ?: System.getenv(key)
    }

    val keystorePath = signingProp("RELEASE_STORE_FILE")
    val keystorePassword = signingProp("RELEASE_STORE_PASSWORD")
